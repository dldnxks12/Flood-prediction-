...
if __name__ == "__main__":
    ...
    model_opt = NoamOpt(model.src_embed[0].model_dim, 1, 1200, torch.optim.Adam(model.parameters(), lr=0, betas=(0.9, 0.98), eps=1e-9))
    ...
    src = src.unsqueeze(0)
    src_mask = torch.ones(1, 1, 7).to(device)
