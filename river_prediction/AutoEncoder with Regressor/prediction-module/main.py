...
class ModuleModel:
    def __init__(self, model_path = None, file_path = None, data_type = None, pred_once = None):
        ...
        # Test
        self.rains_x = np.load('xs_data.npy')[-10, :]
        self.rains_y = np.load('ys_data.npy')[-10, :]
...
if __name__ == '__main__':
    ...
    # Test ...
    # 예측
    prediction, label = model.pred(args)
    rec_module.reconstruction(prediction, label)
    # Test ...
    # ------------------------------------------------ #
